...
import 'package:aiprof/paginas/avaliacao/avaliacao_list_bloc.dart';
  ...
  Widget build(BuildContext context) {
    return Scaffold(
        ...
        body: StreamBuilder<AvaliacaoListBlocState>(
            ...
            launch(
                'https://us-central1-aiia01.cloudfunctions.net/relatorioOnRequest/listadetarefasdaavaliacao?pedido=${snapshot.data.pedidoRelatorio}');

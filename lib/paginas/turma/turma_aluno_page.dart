...
import 'package:aiprof/paginas/turma/turma_aluno_bloc.dart';
      ...
      body: StreamBuilder<TurmaAlunoBlocState>(
        ...
        builder: (BuildContext context, AsyncSnapshot<TurmaAlunoBlocState> snapshot) {
          ...
          if (snapshot.data.pedidoRelatorio != null) {
            launch(
                'https://us-central1-aiia01.cloudfunctions.net/relatorioOnRequest/listadealunosdaturma?pedido=${snapshot.data.pedidoRelatorio}');

...
import 'package:aiprof/paginas/tarefa/tarefa_list_bloc.dart';
            ...
            builder: (BuildContext context,
              ...
              if (snapshot.data.isDataValid) {
                if (snapshot.data.pedidoRelatorio != null) {
                  launch(
                      'https://us-central1-aiia01.cloudfunctions.net/relatorioOnRequest/imprimirtarefa?pedido=${snapshot.data.pedidoRelatorio}');

...
class FolderEditUI extends StatefulWidget {
  final String name;
  ...
  @override
  _FolderEditUIState createState() => _FolderEditUIState();
}

class _FolderEditUIState extends State<FolderEditUI> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text(widget.isAddOrUpdate ? 'Criar pasta' : 'Editar pasta'),
      ),
      body: Padding(

...
class ClassroomEditUI extends StatefulWidget {
  final bool isActive;
  ...
  @override
  _ClassroomEditUIState createState() => _ClassroomEditUIState();
}

class _ClassroomEditUIState extends State<ClassroomEditUI> {

...
class QuestionEditUI extends StatefulWidget {
  final String id;
  final String name;
  ...
  @override
  _QuestionEditUIState createState() => _QuestionEditUIState();
}

class _QuestionEditUIState extends State<QuestionEditUI> {

...
class SituationEditUI extends StatefulWidget {
  final String area;
  final String name;
  ...
  @override
  _SituationEditUIState createState() => _SituationEditUIState();
}

class _SituationEditUIState extends State<SituationEditUI> {

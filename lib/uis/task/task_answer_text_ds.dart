...
class TaskAnswerTextDS extends StatefulWidget {
  final String id;

  final List<Input> simulationInput;
  final List<Output> simulationOutput;

  const TaskAnswerTextDS({
    Key key,
  ...
  @override
  _TaskAnswerTextDSState createState() => _TaskAnswerTextDSState();
}

class _TaskAnswerTextDSState extends State<TaskAnswerTextDS> {
